...
<div class="container">
	...
	<form action="modificaEroe" method="post" enctype="multipart/form-data">
		...
		<input type="text" class="form-control" id="nome" name="nome" value="<c:out value="${eroi.getNome()}" />"
		...
		<div class="input-group input-group-sm mb-3" >
			<div class="input-group-prepend">
				<span class="input-group-text" id="inputGroup-sizing-sm" ><label
					...
					<option value="<c:out value="${eroi.getHeroPower()}" />"> ${eroi.getHeroPower()}</option>
		...
		<input type="text" class="form-control" id="heroDescrizione"
			name="heroDescrizione" value="<c:out value="${eroi.getHeroDescrizione()}" />"
			style="width: 250px; height: 50px; margin: auto"
			placeholder="Hero Power"> <br>
		<p class="text-xl-center">
			<input type="file" id="image" name="image" value="<c:out value="${eroi.getImmagine()}" />"
		...
		<br> <input type="submit"
			...
			<input type="hidden" id="nomeVecchio" name="nomeVecchio"
