...
public class Cliente extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//	req.setAttribute("ratingIniziale", u.getRatingIniziale());
			...
			long totaleEroe = s.getTotalePartiteEroe("Seleziona", "Tutte", u);
			req.setAttribute("totaleEroe", totaleEroe);
			req.setAttribute("listaPartite", s.stampaListaPartite(u));
			long totale = s.getTotalePartite(u);
		//	req.setAttribute("listaComp", s.stampaListaComp());
			req.setAttribute("totale", totale);
			int top4 = s.getTop4(u);
			req.setAttribute("top4", top4);
			int win = s.getWin(u);
			req.setAttribute("win", win);
			int top4Eroe = s.getTop4Eroe("Seleziona", "Tutte", u);
			int winEroe = s.getWinEroe("Seleziona", "Tutte", u);
		...
		//	req.setAttribute("listaEroi", s.stampaListaEroi());
			...
			if (nomeComp.equals("Tutte")) {
				long totaleEroe = s.getTotalePartiteEroeSolo(nomeEroe, u);
				req.setAttribute("ratingIniziale", u.getRatingIniziale());
				req.setAttribute("currentRating", s.calcoloCurrentRating(u));
				req.setAttribute("listaEroi", s.stampaListaEroi());
				req.setAttribute("listaComp", s.stampaListaComp());
				...
				req.setAttribute("top4", top4);
				int win = s.getWin(u);
				int winEroe = s.getWinEroeSolo(nomeEroe, u);
				req.setAttribute("winEroe", winEroe);
				int top4Eroe = s.getTop4EroeSolo(nomeEroe, u);
				req.setAttribute("top4Eroe", top4Eroe);
				req.setAttribute("win", win);
				...
				long totaleEroe = s.getTotalePartiteEroe(nomeEroe, nomeComp, u);
				req.setAttribute("ratingIniziale", u.getRatingIniziale());
				req.setAttribute("currentRating", s.calcoloCurrentRating(u));
				req.setAttribute("listaEroi", s.stampaListaEroi());
				req.setAttribute("listaComp", s.stampaListaComp());
				...
				req.setAttribute("top4", top4);
				int win = s.getWin(u);
				int winEroe = s.getWinEroe(nomeEroe, nomeComp, u);
				req.setAttribute("winEroe", winEroe);
				int top4Eroe = s.getTop4Eroe(nomeEroe, nomeComp, u);
				req.setAttribute("top4Eroe", top4Eroe);
				req.setAttribute("win", win);
				req.setAttribute("eroe", nomeEroe);
				req.setAttribute("comp", nomeComp);
